        ...
        <section id="about" className="scroll-animate w-full bg-background py-16 md:py-24 lg:py-32">
            <div className="container mx-auto px-4 md:px-6">
                <div className="mx-auto max-w-3xl text-center space-y-4">
                    <h2 className="font-headline text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl">About SLK Hana Ola</h2>
                ...
                <div className="mt-12 text-lg text-foreground/80 text-center max-w-4xl mx-auto space-y-8">
                   <div className="text-xl space-y-4">
                       <p className="font-bold text-2xl text-secondary">Because we are committed to your good health...</p>
                       <p>
                   ...
                   <div className="mt-12 grid gap-8 md:grid-cols-2">
                        <Card className="group overflow-hidden rounded-lg shadow-md transition-shadow duration-300 hover:shadow-2xl">
                            <CardHeader>
                                ...
                                <CardTitle className="font-headline text-3xl font-bold text-secondary pt-4">OUR MISSION</CardTitle>
                            </CardHeader>
                            <CardContent>
                                <p className="text-left text-lg">To respectfully and compassionately meet the needs of our clients and their families by listening, planning, educating and delivering the highest quality of individualized home healthcare.</p>
                            </CardContent>
                        </Card>
                        <Card className="group overflow-hidden rounded-lg shadow-md transition-shadow duration-300 hover:shadow-2xl">
                             <CardHeader>
