...
export function AboutSection() {
    return (
        <section id="about" className="scroll-animate h-screen snap-start w-full bg-background flex items-center justify-center">
            <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="mt-12 text-base text-foreground/80 text-center max-w-4xl mx-auto space-y-8">
                   <div className="text-lg space-y-4">
                       <p className="font-bold text-xl text-secondary">Because we are committed to your good health...</p>
                       <p>
