        ...
        <section id="services" className="scroll-animate w-full py-16 md:py-24 lg:py-32">
             <div className="container mx-auto px-4 md:px-6">
                <div className="mx-auto max-w-3xl text-center space-y-4 mb-12">
                    <h2 className="font-headline text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl">Our Services</h2>
                ...
                <div className="grid gap-8 md:grid-cols-1 lg:grid-cols-2">
                    <Card className="flex flex-col group overflow-hidden rounded-lg shadow-md transition-shadow duration-300 hover:shadow-2xl">
                        <CardHeader>
                            ...
                            <CardTitle className="font-headline text-3xl font-bold text-secondary pt-4">Personal Care Services</CardTitle>
                        </CardHeader>
                        <CardContent className="flex-grow">
                            <p className="text-lg">Personal care services shall include activities based on the assessment of the clients’ needs, including but not limited to: personal hygiene and grooming; bathing; skin care; oral hygiene; hair care; dressing; assistance with ambulation, mobility, transfers, and positioning; and assistance with exercise and range of motion.</p>
                        </CardContent>
                    </Card>
                     <Card className="flex flex-col group overflow-hidden rounded-lg shadow-md transition-shadow duration-300 hover:shadow-2xl">
                        <CardHeader>
                    ...
                    <Card className="flex flex-col group overflow-hidden rounded-lg shadow-md transition-shadow duration-300 hover:shadow-2xl">
                        <CardHeader>
                            ...
                            <CardTitle className="font-headline text-3xl font-bold text-secondary pt-4">Assistance With Daily Living</CardTitle>
                        </CardHeader>
                         <CardContent className="flex-grow">
                            <p className="text-lg">We provide support with daily activities to help our clients maintain their independence and quality of life at home.</p>
                        </CardContent>
                    </Card>
                     <Card className="flex flex-col group overflow-hidden rounded-lg shadow-md transition-shadow duration-300 hover:shadow-2xl">
                        <CardHeader>
                            ...
                            <CardTitle className="font-headline text-3xl font-bold text-secondary pt-4">Companionship</CardTitle>
                        </CardHeader>
                         <CardContent className="flex-grow">
                            <p className="text-lg">Our caregivers offer companionship and emotional support, engaging in activities that our clients enjoy and ensuring they feel connected.</p>
                        </CardContent>
                    </Card>
                </div>
                <div className="mt-12 text-center">
                     <p className="text-2xl font-bold text-primary pt-6">
